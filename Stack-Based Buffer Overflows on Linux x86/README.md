...
- [Introduction](#introduction)
  ...
  - [CPU Architecture](#cpu-architecture)
    ...
    - [Central Processing Unit](#central-processing-unit)
      - [RISC](#risc)
      - [CISC](#cisc)
    - [Instruction Cycle](#instrucion-cycle)
- [Fundamentals](#fundamentals)
  - [Stack-Based Buffer Overflow](#stack-based-buffer-overflow)
    - [The Memory](#the-memory)
    - [Disable ASLR](#disable-aslr)
    - [Compile C code to a 32bit ELF binary](#compile-c-code-to-a-32bit-elf-binary)
    - [AT&T Syntax](#att-syntax)
      - [Break down the info](#break-down-the-info)
   - [Intel Syntax](#intel-syntax)
   - [Change GDB Syntax](#change-gdb-syntax)
   - [Q: At which address in the "main" function is the "bowfunc" function gets called?](#q--at-which-address-in-the-main-function-is-the-bowfunc-function-gets-called)
...
- [Exploit](#exploit)
  - [Take Control of EIP](#take-control-of-eip)
  - [Determine the Length for Shellcode](#determine-the-length-for-shellcode)
    - [Use in practice](#use-in-practice)
  - [Identification of Bad Characters](#identification-of-bad-characters)
    - [Breakpoints](#breakpoints)
    - [Sending the characters](#sending-the-characters)
    - [Q: Find all bad characters that change or interrupt our sent bytes' order and submit them as the answer (e.g., format: \x00\x11).](#q-find-all-bad-characters-that-change-or-interrupt-our-sent-bytes-order-and-submit-them-as-the-answer-eg-format-x00x11)
  - [Generating Shellcode](#generating-shellcode)
    ...
    - [The Stack](#the-stack)
  - [Identification of the Return Address](#identification-of-the-return-address)
    - [GDB NOPS](#gdb-nops)
    - [Exploitation](#exploitation)
- [Proof-Of-Concept](#proof-of-concept)
  - [Public Exploit Modification](#public-exploit-modification)
